...
export const HowToPartner: React.FC = () => {
  return (
    <section className="w-full bg-indigo-50 dark:bg-brand-dark-bg-nav py-16 px-4">
      <div className="max-w-4xl mx-auto text-center">
        <h2 className="text-3xl md:text-4xl font-bold text-gray-800 dark:text-brand-text-dark-heading">
          How to Partner With Us
        </h2>
        <p className="text-gray-600 mt-2 md:text-lg max-w-2xl mx-auto dark:text-brand-text-dark">
      ...
      <div className="mt-10 max-w-3xl mx-auto p-4 dark:bg-card  bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow border border-indigo-100 flex items-start gap-4">
...
>>>>>>> 8cca54fc40fb17b2a71096f533042e39ee984838
      ...
      <ol className="mt-4 max-w-3xl mx-auto space-y-2">
        {[
          ...
          <li
            key={index}
            className="flex items-start gap-4 p-4 dark:bg-card bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow border border-indigo-100"
          >
